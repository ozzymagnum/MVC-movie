...
namespace MVC_movie_app.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public MoviesController(MVC_movie_appContext context, UserManager<MVC_movie_appUser> userManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Movie != null ? 
                          ...
                          Problem("Entity set 'MVC_movie_appContext.Movie'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MVC_movie_appContext.Movie'  is null.");
            }
            var movie = await _context.Movie.FindAsync(id);
            if (movie != null)
            {
